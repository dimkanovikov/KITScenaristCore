        ...
        if (!data->dialogues.isEmpty()) {
            ...
            foreach (const QVariantList dialogueData, data->dialogues) {
                if (!dialogueData.first().toString().isEmpty()) {
                    ...
                    if (_parameters.characterNames.size() == 1) {
                        dialogueText.append(
                                    QString("<tr><td><a href=\"inapp://scenario?position=%2&from=statistics\">%1</a></td></tr>")
                    ...
                    //
                        ...
                        dialogueText.append(
                                    QString("<tr><td>%1</td><td width=\"100%\"><a href=\"inapp://scenario?position=%3&from=statistics\">%2</a></td></tr>")
